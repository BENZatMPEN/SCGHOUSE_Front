...
const LogUpdatePage: React.FC = () => {
    ...
    const fetchDataFromAPI = useCallback(async () => {
        ...
        axios
            .get(`${process.env.REACT_APP_BACKEND_API_ENDPOINT}/api/update/install-date`, config)
            // .get(`${process.env.REACT_APP_BACKEND_API_ENDPOINT}/api/update/install-date?perPage=${pagination.pageSize}&page=${pagination.current}`, config)
            .then((response) => {
    ...
    return (
        <LayoutComp>
            <div className="h-screen">
                <h2 className="text-2xl text-dark-01 font-bold">Log Update</h2>
